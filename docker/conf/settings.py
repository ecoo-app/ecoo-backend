...
# OAUTH
SOCIAL_AUTH_APPLE_ID_CLIENT = os.environ.get('APPLE_ID_CLIENT', '?') # Your client_id com.application.your, aka "Service ID"
SOCIAL_AUTH_APPLE_ID_TEAM = os.environ.get('APPLE_ID_TEAM', '?') # Your Team ID, ie K2232113
SOCIAL_AUTH_APPLE_ID_KEY = os.environ.get('APPLE_ID_KEY', '?') # Your Key ID, ie Y2P99J3N81K
