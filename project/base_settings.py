...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(months=4),
    'REFRESH_TOKEN_LIFETIME': timedelta(months=6),
    ...
    'SLIDING_TOKEN_LIFETIME': timedelta(months=4),
    'SLIDING_TOKEN_REFRESH_LIFETIME': timedelta(months=6),
}
