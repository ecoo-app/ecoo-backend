...
from apps.verification.views import verify_company_profile_pin, verify_user_profile_pin, resend_user_profile_pin, AutocompleteUserList, AutocompleteCompanyList, AddressPinVerificationView
...
urlpatterns = [
    ...
    path('autocomplete_user/', AutocompleteUserList.as_view(),
         name='autocomplete_user'),
    path('autocomplete_company/', AutocompleteCompanyList.as_view(),
